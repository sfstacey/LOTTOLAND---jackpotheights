...
$('.rio_clouds').load($imgpath+'rio_clouds.svg');
...
$('.logo_graphic').load($imgpath+'logo.svg');
...
//londoneye
var london_eye_spin = new ScrollMagic.Scene({triggerElement:'#london', offset:-500,  duration:1850}).setTween(TweenMax.to(".london_eye",1, {rotation:360})).addTo($animation_controller);
...
var capetown_coinpile = new ScrollMagic.Scene({triggerElement:'#capetown', offset:410, duration:3000}).setTween(TweenMax.to(".coinpile.capetown",1,{'display':'none', 'height':'0'})).addTo($animation_controller).addIndicators();
var dubai_coinpile = new ScrollMagic.Scene({triggerElement:'#dubai', offset:410, duration:3000}).setTween(TweenMax.to(".coinpile.dubai",1,{'display':'none', 'height':'0'})).addTo($animation_controller).addIndicators();
